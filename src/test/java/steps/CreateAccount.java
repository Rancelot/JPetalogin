...
public class CreateAccount {
	...
	public void i_create_new_account_using_and_and_and_and_and_and_and_and_and_and_and_press_save_account_information(
	...
	public void i_should_get_an_error_message_that_account_could_not_be_created() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		try {
			driver.findElement(By.cssSelector("#Content > ul > li"));
		} catch (Exception e) {
			fail();
		} finally {
			driver.quit();
	...
	public void i_should_get_an_error_message_that_passwords_do_not_match() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		try {
			driver.findElement(By.cssSelector("#Content > ul > li"));
		} catch (Exception e) {
	...
	public void i_should_get_an_error_message_that_account_is_missing_information() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		try {
			driver.findElement(By.cssSelector("#Content > ul > li"));
		} catch (Exception e) {
	...
	public void i_create_new_account_using_no_account_information() throws Throwable {
		driver.findElement(By.name("newAccount")).click();
	}

	@When("^I create new account using \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and press save account information$")
	public void i_create_new_account_using_and_and_and_and_and_and_and_and_and_and_and_and_press_save_account_information(
			String arg1, String arg2, String arg3, String arg4, String arg5, String arg6, String arg7, String arg8,
			String arg9, String arg10, String arg11, String arg12) throws Throwable {
		driver.findElement(By.name("username")).sendKeys(arg1);
		driver.findElement(By.name("password")).sendKeys(arg2);
	...
	@When("^I create new account with mybanner using \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and \"([^\"]*)\" and press save account information$")
	public void i_create_new_account_with_mybanner_using_and_and_and_and_and_and_and_and_and_and_and_press_save_account_information(
			String arg1, String arg2, String arg3, String arg4, String arg5, String arg6, String arg7, String arg8,
			String arg9, String arg10, String arg11) throws Throwable {
		driver.findElement(By.name("username")).sendKeys(arg1);
		driver.findElement(By.name("password")).sendKeys(arg2);
	...
	@Then("^I should be able to login successfully using that \"([^\"]*)\" and \"([^\"]*)\" and see a banner$")
	public void i_should_be_able_to_login_successfully_using_that_and_and_see_a_banner(String arg1, String arg2)
			throws Throwable {
		try {
			driver.findElement(By.linkText("Sign In")).click();
			driver.findElement(By.name("username")).clear();
			...
			driver.findElement(By.cssSelector("#Banner > img"));
		} catch (Exception e) {
			fail();
		} finally {
			driver.quit();
